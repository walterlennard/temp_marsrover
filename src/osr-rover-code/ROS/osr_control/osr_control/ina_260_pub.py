#Selbst geschrieben damit venv verwendet wird
import sys
import os
...
print("ina260.controller erfolgreich geladen!")
...
class INA260Node(Node):
    def __init__(self):
        ...
        #Adresse von 0x45 auf 0x40 geändert, da durch vorheriges Testen 0x40 richtig war
